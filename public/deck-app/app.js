...
function renderClassButtons() {
  return `<div class="class-grid">${state.abilities.map((cat, i) => `<button class="btn small ${state.abilityCategory?.name === cat.name ? 'active' : ''}" data-class="${i}">${cat.name}</button>`).join('')}</div>`;
}
    ...
    <div class="deck-app shell">
      <div class="deck-toolbar">
        ...
        <div class="toolbar-actions wrap">
          <button id="play" class="btn primary">Play cards</button>
...
function bindEvents() {
  ...
  ['play', 'playTop'].forEach(id => document.getElementById(id)?.addEventListener('click', playSelected));
  ['shortRest', 'shortRestTop'].forEach(id => document.getElementById(id)?.addEventListener('click', shortRest));
  ['newGame', 'newGameTop'].forEach(id => document.getElementById(id)?.addEventListener('click', newGame));
